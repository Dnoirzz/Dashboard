...
class Dashboard(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("Icon/Buku.png"))
        ...
        icon_label.setPixmap(QPixmap("Icon/Buku.png"))
        ...
        profile_icon.setPixmap(QPixmap("Icon/Admin1.png"))
        ...
        dashboard_button = create_sidebar_button("Dashboard",None, "Icon/home.png")
        koleksi_button = create_sidebar_button("Koleksi", None, "Icon/koleksi.png")
        kelola_button = create_sidebar_button("Kelola Data", None, "Icon/open-folder.png")
        kelola_button.clicked.connect(self.toggle_kelola_submenu)

        log_data_button = create_sidebar_button("Log Data", None, "Icon/log-data.png")
        ...
        logout_button = create_sidebar_button("Logout", None, "Icon/logout.png")
